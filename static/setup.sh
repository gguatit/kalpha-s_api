...
# Prepare the installed CLI (simple stub)
...
# API key can be passed via DEAD_API_KEY env var
...
# Install, using sudo if necessary
...
if command -v dead >/dev/null 2>&1; then
  echo "Run 'dead --help' or 'dead -h' to get started."
else
